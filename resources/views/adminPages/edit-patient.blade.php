...
<head>
    ...
    @include('includes.admin.css-admin')
        ...
        <div class="header">
            <div class="header-left">
                <a href="index-2.html" class="logo">
                    <img src="{{asset('assets-home/img/favicon.png')}}" width="35" height="35" alt=""> <span>DadeLab</span>
                </a>
            </div>
            ...
            <ul class="nav user-menu float-right">
                            ...
                            <ul class="notification-list">
                                <li class="notification-message">
                                    <a href="activities.html">
                                        <div class="media">
                                            <span class="avatar">
                                                <img alt="John Doe" src="assets-admin/img/user.jpg" class="img-fluid">
                                            </span>
                ...
                <li class="nav-item dropdown has-arrow">
                    <a href="#" class="dropdown-toggle nav-link user-link" data-toggle="dropdown">
                        <span class="user-img">
                            <img class="rounded-circle" src="{{asset('assets-admin/img/user.jpg')}}" width="24" alt="Admin">
            ...
            <div class="sidebar-inner slimscroll">
                <div id="sidebar-menu" class="sidebar-menu">
                    <ul>
                        ...
                        <li >
                            <a href="/admin/doctors"><i class="fa fa-user-md"></i> <span>Doctors</span></a>
                        </li>
                        <li class="active">
                            <a href="/admin/patients"><i class="fa fa-wheelchair"></i> <span>Patients</span></a>
                        </li>
                        <li >
                            <a href="/admin/appointments"><i class="fa fa-calendar"></i> <span>Appointments</span></a>
                        </li>
                        <li>
                    ...
                    <div class="col-lg-8 offset-lg-2">
                        <form method="POST" action="{{ route('patients.update',$patient->id) }}">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="dropdown ">
                                        <select class="custom-select" id="inputGroupSelect04" name="bloodType">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <div >
                                            <input type="date" class="form-control datetimepicker" name="dob" >
                                        </div>
                                    </div>
                                </div>
                                <div class="col-sm-6">
